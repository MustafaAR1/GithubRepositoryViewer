...
class _$GithubRepoDTOTearOff {
  ...
  _GithubRepoDTO call(
    ...
    return _GithubRepoDTO(
      ...
      stargarzersCount: stargarzersCount,
    );
  }
...
mixin _$GithubRepoDTO {
  ...
  int get stargarzersCount => throw _privateConstructorUsedError;
...
abstract class $GithubRepoDTOCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'stargazers_count') int stargarzersCount});
...
class _$GithubRepoDTOCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? stargarzersCount = freezed,
  }) {
    return _then(_value.copyWith(
      ...
      description: description == freezed
          ...
          : description // ignore: cast_nullable_to_non_nullable
              as String,
      stargarzersCount: stargarzersCount == freezed
          ? _value.stargarzersCount
          : stargarzersCount // ignore: cast_nullable_to_non_nullable
              as int,
    ));
  }
...
class _$_GithubRepoDTO extends _GithubRepoDTO {
  const _$_GithubRepoDTO(
      ...
      @JsonKey(name: 'stargazers_count') required this.stargarzersCount})
      : super._();
  ...
  @override
  @JsonKey(name: 'stargazers_count')
  final int stargarzersCount;

  @override
  String toString() {
    return 'GithubRepoDTO(owner: $owner, name: $name, description: $description, stargarzersCount: $stargarzersCount)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.stargarzersCount, stargarzersCount));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(stargarzersCount));
