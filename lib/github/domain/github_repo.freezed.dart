...
mixin _$GithubRepo {
  ...
  int get startGazersCount => throw _privateConstructorUsedError;
...
abstract class $GithubRepoCopyWith<$Res> {
  ...
  $Res call(
      {User owner, String name, String description, int startGazersCount});
...
class _$GithubRepoCopyWithImpl<$Res> implements $GithubRepoCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object? startGazersCount = freezed,
  }) {
    return _then(_value.copyWith(
      ...
      description: description == freezed
          ...
          : description // ignore: cast_nullable_to_non_nullable
              as String,
      startGazersCount: startGazersCount == freezed
          ? _value.startGazersCount
          : startGazersCount // ignore: cast_nullable_to_non_nullable
              as int,
    ));
  }
...
class _$_GithubRepo extends _GithubRepo {
  const _$_GithubRepo(
      ...
      required this.startGazersCount})
      : super._();
  ...
  @override
  final int startGazersCount;

  @override
  String toString() {
    return 'GithubRepo(owner: $owner, name: $name, description: $description, startGazersCount: $startGazersCount)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.startGazersCount, startGazersCount));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(startGazersCount));
...
abstract class _GithubRepo extends GithubRepo {
  const factory _GithubRepo(
      ...
      required String name,
      required String description,
      required int startGazersCount}) = _$_GithubRepo;
